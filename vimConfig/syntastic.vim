...
let g:syntastic_quiet_messages = {'level': 'warnings'} "let g:syntastic_quiet_warnings=0 "this is default, so warnings will mess up with error(can not see any difference it makes.)
